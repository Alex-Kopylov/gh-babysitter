...
The scheduled GitHub Actions workflow reads the repository variables
`E2E_PRIMARY_REPO` and `E2E_SECONDARY_REPO`, plus the encrypted secrets
`E2E_PRIMARY_TOKEN` and `E2E_SECONDARY_TOKEN`. CI sets
